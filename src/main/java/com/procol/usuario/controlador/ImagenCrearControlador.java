...
import com.procol.usuario.servicio.ImagenCrearServicio;
...
public class ImagenCrearControlador {
    ...
    public ImagenCrearControlador(ImagenCrearServicio imagenCrearServicio) {
